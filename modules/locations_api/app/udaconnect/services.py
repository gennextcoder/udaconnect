...
from app import db
from app.udaconnect.models import Location, LocationWithPersonID
...
class LocationService:
    ...
    def retrieve_connections_partial(person_id, start_date, end_date, distance) -> List[LocationWithPersonID]:
        ...
        result: List[LocationWithPersonID] = []
        for line in tuple(data):
            for (
                ...
                result.append(
                    LocationWithPersonID(
                        person_id=exposed_person_id, location=location,
                    )
                )
